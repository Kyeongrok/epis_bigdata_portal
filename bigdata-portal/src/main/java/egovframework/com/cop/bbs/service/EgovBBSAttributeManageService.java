...
public interface EgovBBSAttributeManageService {
     ...
     * @param BoardMaster
     */
    String insertBBSMastetInf(BoardMaster boardMaster) throws Exception;
     ...
     * @param BoardMasterVO
     */
    BoardMasterVO selectBBSMasterInf(BoardMaster searchVO) throws Exception;
     ...
     * @param BoardMasterVO
     */
    void validateTemplate(BoardMasterVO searchVO) throws Exception;
     ...
     * @param BoardMasterVO
     */
    Map<String, Object> selectBdMstrListByTrget(BoardMasterVO vo) throws Exception;
     ...
     * @throws Exception
     */
    Map<String, Object> selectNotUsedBdMstrList(BoardMasterVO vo) throws Exception;
}
