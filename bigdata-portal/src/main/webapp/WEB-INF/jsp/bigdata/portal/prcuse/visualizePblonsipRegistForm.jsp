...
<script type="text/javascript" src="<c:url value="/js/bigdata/portal/prcuse/visualizePblonsipRegistForm.js" />"></script>  

    
<div class="wrap_admin">

	<h3 class="mt0"><i class="ico ico_arrow_grey"></i>시각화 공유 등록</h3>

	<form name="rf" id="rf">
	<input type="hidden" name="bbsGbn" value="V" />
