   ...
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <c:if test="${brdMstrVO.authFlag == 'Y'}">
	      <td class="button" nowrap><a href="<c:url value='/cop/bbs${prefix}/addBoardArticle.do'/>" onClick="fn_egov_addNotice(); return false;"><spring:message code="button.create" /></a></td>
      </c:if>
    </tr>
   </table>
  </th>
