...
public class EgovProperties {
	...
	final static String PROJECT_PROFILE = System.getProperty("spring.profiles.active");
    ...
    //프로퍼티 파일의 물리적 위치
    public static final String GLOBALS_PROPERTIES_FILE = RELATIVE_PATH_PREFIX + "egovProps" + FILE_SEPARATOR + PROJECT_PROFILE + FILE_SEPARATOR + "globals.properties"; // 프로필 적용
    //public static final String GLOBALS_PROPERTIES_FILE = System.getProperty("user.home") + FILE_SEPARATOR + "egovProps" +FILE_SEPARATOR + "globals.properties"; // 프로필 미적용

    //public static final String RELATIVE_PATH_PREFIX = EgovProperties.class.getResource("").getPath()	+ FILE_SEPARATOR+ ".." + FILE_SEPARATOR  + ".." + FILE_SEPARATOR; // 미사용
