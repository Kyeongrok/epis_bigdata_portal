...
<div id="border" style="width:730px">
	...
	<!-- 
     ...
     -->
	  ...
	  <td><span class="button"><input type="submit" value="<spring:message code="button.update" />" title="<spring:message code="button.update" />" onclick="fn_egov_update_tmplatInfo();return false;"></span></td>
      <td width="10"></td>
	...
	<!-- 
      ...
      <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
    -->
	  <td><span class="button"><input type="button" value="<spring:message code="button.list" />" title="<spring:message code="button.list" />" onclick="fn_egov_select_tmplatInfo();return false;"></span></td>
      <td width="10"></td>
      ...
      <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
	  -->
	  <td><span class="button"><input type="button" value="<spring:message code="cop.preview" />" title="<spring:message code="cop.preview" />" onclick="fn_egov_previewTmplat();return false;"></span></td>
	</tr>
	</table>
	</div>
</div>
