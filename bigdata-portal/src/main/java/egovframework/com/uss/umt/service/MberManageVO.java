...
public class MberManageVO extends UserDefaultVO{
	...
	public static MberManageVO parseMber(JSONObject userInfo) {
		MberManageVO mber = new MberManageVO();
		
		mber.setAdres(userInfo.get("userAdres").toString());
		mber.setMberNm(userInfo.get("userNm").toString());
		mber.setMberId(userInfo.get("userId").toString());
		mber.setZip(userInfo.get("userZip").toString());
		mber.setMberEmailAdres(userInfo.get("userEmail").toString());
		mber.setPassword(userInfo.get("password").toString());
		mber.setPasswordCnsr(userInfo.get("passwordCnsr").toString());
		mber.setPasswordHint(userInfo.get("passwordHint").toString());
		mber.setAreaNo(userInfo.get("areaNo").toString());
		mber.setEndTelno(userInfo.get("endTelNo").toString());
		mber.setMiddleTelno(userInfo.get("middleTelNo").toString());
		mber.setMoblphonNo(userInfo.get("moblphonNo").toString());
		mber.setMberSttus(userInfo.get("sttus").toString());
