...
public class EntrprsManageVO  extends UserDefaultVO{
	 ...
	 * @return
	 */
	public static EntrprsManageVO parseEntrprs(JSONObject userInfo) {
		EntrprsManageVO entrprs = new EntrprsManageVO();
		
		entrprs.setAdres(userInfo.get("userAdres").toString());
		entrprs.setApplcntNm(userInfo.get("userNm").toString());
		entrprs.setEntrprsmberId(userInfo.get("userId").toString());
		entrprs.setZip(userInfo.get("userZip").toString());
		entrprs.setApplcntEmailAdres(userInfo.get("userEmail").toString());
		entrprs.setEntrprsMberPassword(userInfo.get("password").toString());
		entrprs.setEntrprsMberPasswordCnsr(userInfo.get("passwordCnsr").toString());
		entrprs.setEntrprsMberPasswordHint(userInfo.get("passwordHint").toString());
		entrprs.setAreaNo(userInfo.get("areaNo").toString());
		entrprs.setEntrprsEndTelno(userInfo.get("endTelNo").toString());
		entrprs.setEntrprsMiddleTelno(userInfo.get("middleTelNo").toString());
		entrprs.setEntrprsMberSttus(userInfo.get("sttus").toString());
		
		// 핸드폰번호 없음
		//entrprs.set(userInfo.get("moblphonNo").toString());
