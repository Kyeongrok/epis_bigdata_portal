...
<h3 class="mt0"><i class="ico ico_arrow_grey"></i>IP접근 설정 수정</h3>
...
<table class="tbl02 adm_tbl02 column2" summary="권한을 수정하는 테이블입니다.권한 코드,권한 명,설명,등록일자 정보를 담고 있습니다.">
		...
		<tr>
			...
			<td>
				<input name="ipInfo" id="ipInfo" value="<c:out value='${loginPolicy.ipInfo}'/>" title="IP정보" type="text" maxLength="23" size="30"  >
			</td>
		</tr>		
		<tr>
  ...
  <tr>
    <th scope="row" nowrap>등록일시<em>*</em></th>
    <td>
    	<input name="regDate" id="regDate" title="등록일시" type="text" value="<c:out value='${loginPolicy.regDate}'/>" maxLength="50" size="20" class="readOnlyClass" readOnly ></td>
  </tr>
</table>

<div class="tac mt20 disinblock w100p">
	<a class="btn grey" href="#LINK" onclick="fncLoginPolicyUpdate(); return false;">확인</a>
	<a class="btn red" href="<c:url value='/uat/uap/removeLoginPolicy.do'/>?emplyrId=<c:out value='${loginPolicyVO.emplyrId}'/>" onclick="fncLoginPolicyDelete(); return false;">삭제</a>
