...
<tr style="cursor:pointer;cursor:hand;" onclick="fn_egov_detail_AdministCodeRecptn('<c:out value="${resultInfo.administZoneSe}"/>','<c:out value="${resultInfo.administZoneCode}"/>');">
