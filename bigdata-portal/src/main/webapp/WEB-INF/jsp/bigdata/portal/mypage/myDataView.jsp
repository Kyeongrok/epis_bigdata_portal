...
<script type="text/javascript" src="<c:url value="/js/bigdata/portal/mypage/myDataView.js" />"></script>  

    
<div class="wrap_admin">

	<h3 class="mt0"><i class="ico ico_arrow_grey"></i>나의 데이터 조회</h3>
	...
	<div class="tac mt20 disinblock w100p">
		...
		<div class="floatr">
			<c:if test="${isLogin == true && loginUserId == data.ntcrId}">
				<a href="javascript:;"  class="btn red updt">수정</a>			
				<a href="javascript:;"  class="btn red delete">삭제</a>
				<a href="javascript:;"  class="btn red upload">kafka 업로드</a>	
			</c:if>	
