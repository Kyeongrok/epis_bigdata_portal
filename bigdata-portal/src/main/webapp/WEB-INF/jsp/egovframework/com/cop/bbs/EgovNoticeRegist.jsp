		  ...
		  <tr>
		    ...
		    <td colspan="3">
		      ...
		      <input name="ntceBgndeView" type="text" size="10" value=""  readOnly
		      	onClick="fn_egov_NormalCalendar(document.board, document.board.ntceBgnde, document.board.ntceBgndeView);" title="게시시작일자입력">
		      ...
		      <input name="ntceEnddeView" type="text" size="10" value=""  readOnly
		      	onClick="fn_egov_NormalCalendar(document.board, document.board.ntceEndde, document.board.ntceEnddeView);" title="게시종료일자입력">
		      <img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"
	...
	<tr>
      ...
      <!--
	   ...
	   -->
	  	  <td>
	  	  	<span class="button">
	  	  		<input type="button" value="<spring:message code="button.create" />" title="<spring:message code="button.create" />" onclick="fn_egov_regist_notice();return false;">
	  	  	</span>
	  	  </td>
	  	  <td width="10"></td>
      </c:if>
      ...
      <td>
	  	  <span class="button">
	  	  	<input type="button" value="<spring:message code="button.list" />" title="<spring:message code="button.list" />" onclick="fn_egov_select_noticeList();return false;">
	  	  </span>
	  </td>
	</tr>
	</table>
