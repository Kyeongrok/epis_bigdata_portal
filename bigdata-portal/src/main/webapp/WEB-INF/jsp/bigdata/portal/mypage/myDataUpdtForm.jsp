...
<script type="text/javascript" src="<c:url value="/js/bigdata/portal/mypage/myDataUpdtForm.js" />"></script>

<div class="wrap_admin">

	<h3 class="mt0"><i class="ico ico_arrow_grey"></i>내 데이터 수정</h3>

	<form name="uf" id="uf" accept-charset="UTF-8">
	...
	<table class="tbl02 column3">
		<tr>
			<th>데이터명<em>*</em></th>
			<td>
				<input type="text" name="nttSj"  class="w100p" title="데이터명" data-vreq value="${data.nttSj }"/>
			</td>
		</tr>
		<tr>
			<th>데이터내용<em>*</em></th>
			<td>
				<textarea name="nttCn" rows="5" cols="100" class="w100p" title="데이터내용" data-vreq>${data.nttCn }</textarea>
			</td>
		</tr>
		<tr>
			<th>데이터<em></em></th>
