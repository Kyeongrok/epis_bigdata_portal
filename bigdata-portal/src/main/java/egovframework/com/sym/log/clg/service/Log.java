...
public class Log implements Serializable {
	...
	public String toString() {
		return "Log [logId=" + logId + ", loginId=" + loginId + ", userId=" + userId + ", loginNm=" + loginNm
				+ ", loginIp=" + loginIp + ", loginMthd=" + loginMthd + ", errOccrrAt=" + errOccrrAt + ", errorCode="
				+ errorCode + ", creatDt=" + creatDt + ", searchBgnDe=" + searchBgnDe + ", searchCnd=" + searchCnd
				+ ", searchEndDe=" + searchEndDe + ", searchWrd=" + searchWrd + ", sortOrdr=" + sortOrdr
				...
				+ recordCountPerPage + ", rowNo=" + rowNo + ", searchBgnDeView=" + searchBgnDeView
				+ ", searchEndDeView=" + searchEndDeView + ", logDesc=" + logDesc + "]";
	}
