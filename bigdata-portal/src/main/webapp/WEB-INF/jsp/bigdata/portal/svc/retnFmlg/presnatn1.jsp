...
<script src="<c:url value='/js/bigdata/portal/svc/retnFmlg/sc_a.js'/>" defer></script>
<script src="<c:url value='/js/bigdata/portal/svc/retnFmlg/sc_b.js'/>" defer></script>
...
<!-- 중앙 컨텐츠 영역 -->
        <section class="cntWrap result" id="main_content">
	    	...
	    	<div class="menuTop" id="menu_top">
	    		<ul>
	    			<li class="on"><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_01.html#result02" class="scrollMove"><span>지역정보</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_01.html#result05" class="scrollMove"><span>지원정책</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_01.html#result03" class="scrollMove"><span>정주여건</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_01.html#result04" class="scrollMove"><span>품목정보</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_01.html#result01" class="scrollMove"><span>귀농인정보</span></a></li>
	    		</ul>
	    	</div>
	    	<!-- //상단고정 -->
	        	...
	        	<div class="row mt20">
        			<div class="areaList w65p">
						...
						<!--
							선택된 버튼에 class = on
						-->
        				<button type="button" class="num01 on" onclick="location.href='./test1.do;'">
	        ...
	        <div class="resultBox support" id="result05">
	        	<h3>지역맞춤 귀농교육 및 지원정책 - 전라북도 순창군</h3>
	        	...
	        	<a id="btn_popup_open" href="#">
		        	<img src="/images/bigdata/svc/retnFmlg/smpl_img02.png" alt="다이어그램" style="margin:10px 0 0 0;display:inline-block;">
		        </a>
	        </div><!-- //resultBox result05 -->


	        <div class="resultBox" id="result03">
	        	<h3>지역 정주 여건 정보 - 전라북도 순창군</h3>
		    	<div class="tabWrap has8Tab">
                	...
                	<div class="tabContWrap">
                		<div class="tabcontent on">
                			<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph19.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
                			<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_0_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_0_1" ></canvas></div>
                			</div>
                			<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_0_2" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_0_3" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph20.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
            				<div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="sc_a_1_0" ></canvas></div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="sc_a_1_1" ></canvas></div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="sc_a_1_2" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph21.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_2_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_2_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph22.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_3_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_3_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph23.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_4_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_4_1" ></canvas></div>
                			</div>
<!--                 			<div> -->
<%-- 	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_4_2" ></canvas></div> --%>
<%-- 	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_4_3" ></canvas></div> --%>
<!--                 			</div> -->
                		</div>
                		<div class="tabcontent">
            				<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph24.png" alt="" style="margin:35px 0 0 25px;display:inline-block;"> -->
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_a_5_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="sc_a_5_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
	        	...
	        	<div class="tabWrap">
		        	<ul class="tabTitle itemList">
                		...
                		<li class="tablinks on">
	        				<button type="button"><span>두릅</span></button>
                		</li>
                		<li class="tablinks">
	        				<button type="button"><span>콩</span></button>
                		</li>
                		<li class="tablinks">
	        				<button type="button"><span>블루베리</span></button>
                		</li>
                	</ul>
                	<div class="tabContWrap">
                		<div class="tabcontent on">
            				<div class="tabWrap has5Tab">
			                	...
			                	<div class="tabContWrap">
			                		<div class="tabcontent on">
			            				...
			            				<%-- <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_d_0_0" ></canvas></div>
			                			</div> --%>
			                		</div>
			                		<div class="tabcontent">
				                		<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph27.png" alt="" style="margin:30px 0 10px 0;display:inline-block;"> -->
				                		<div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_d_1_0" ></canvas></div>
			                			</div>
			                		</div>
			                		<div class="tabcontent">
			                		  	<img src="/images/bigdata/svc/retnFmlg/smpl_graph28.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
			                		  	<%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_d_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_d_2_1" ></canvas></div>
			                			</div> --%>
			                		</div>
			                		<div class="tabcontent">
				                		<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_graph29.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;"> -->
				                		<div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_d_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_d_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_d_3_2" ></canvas></div>
			                			</div>
			                		</div>
			                		<div class="tabcontent">
            				...
            				<div class="tabWrap has5Tab">
                                ...
                                <div class="tabContWrap">
                                    <div class="tabcontent on">
                                        ...
                                        <%-- <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_k_0_0" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <!-- <img src="/images/bigdata/svc/retnFmlg/smpl_bean02.png" alt="" style="margin:30px 0 10px 0;display:inline-block;"> -->
                                        <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_k_1_0" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                        <img src="/images/bigdata/svc/retnFmlg/smpl_bean03.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
                                        <%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_k_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_k_2_1" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <!-- <img src="/images/bigdata/svc/retnFmlg/smpl_bean04.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;"> -->
                                        <div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_k_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_k_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_k_3_2" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
            				...
            				<div class="tabWrap has5Tab">
                                ...
                                <div class="tabContWrap">
                                    <div class="tabcontent on">
                                        ...
                                        <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_b_0_0" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                        <!-- <img src="/images/bigdata/svc/retnFmlg/smpl_berry02.png" alt="" style="margin:30px 0 10px 0;display:inline-block;"> -->
                                        <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_b_b_1_0" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                        <img src="/images/bigdata/svc/retnFmlg/smpl_berry03.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
                                        <%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_b_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="sc_b_b_2_1" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <!-- <img src="/images/bigdata/svc/retnFmlg/smpl_berry04.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;"> -->
                                        <div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_b_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_b_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="sc_b_b_3_2" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
				...
				<div class="tabWrap has5Tab">
                	...
                	<div class="tabContWrap">
                		<div class="tabcontent on">
                			...
                			<%-- <div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_c_0_0" ></canvas></div>
                			</div> --%>
                		</div>
                		<div class="tabcontent">
                		...
                		<div class="tabcontent">
                			<div>
                				<canvas id="sc_c_t2_0" height="250"></canvas>
                			</div>
                			<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_img09.png" alt="" style="margin:20px 0 10px 10px;display:inline-block;"> -->
                			<%-- <div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_c_0_2" ></canvas></div>
                			</div> --%>
                		</div>
                		<div class="tabcontent">
                			<div>
                				<canvas id="sc_c_t3_0" height="250"></canvas>
                			</div>
                			<!-- <img src="/images/bigdata/svc/retnFmlg/smpl_img10.png" alt="" style="margin:20px 0 10px 10px;display:inline-block;"> -->
                			<%-- <div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="sc_c_0_3" ></canvas></div>
                			</div> --%>
                		</div>
                		<div class="tabcontent">
...
// $(function(){
// 	tempSrchObj.sido = '전라북도';
// 	tempSrchObj.sigungu = '순창군';
// 	tempSrchObj.umd = '순창읍';
// })
</script>