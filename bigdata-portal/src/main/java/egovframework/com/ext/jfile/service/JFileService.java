...
public interface JFileService {
     ...
     */
    String getFileId(String fileId, Object fileSeq);
     ...
     */
    List<JFileDetails> getAttachFiles(String fileId);
     ...
     */
    JFileDetails getAttachFile(String fileId, String fileSeq);
     ...
     */
    Object[] getAttacheFileSeqs(String fileId);
     ...
     */
    void updateAttachFileDeleteYnByFileId(String fileId, String deleteYn);
     ...
     * @param fileId 파일 아이디.
     */
    void updateAttachFileDownloadCount(String fileId);
     ...
     * @param fileId 파일 아이디.
     */
    void updateAttachFileDownloadCount(String fileId, String fileSeq);
     ...
     * @param deleteYn 삭제 여부.
     */
    void updateAttachFileDeleteYn(String fileId, Object[] fileSeqs, String yn);
     ...
     * @param fileSeq 파일 시퀀스.
     */
    void updateAttachFileDownloadCountBySequence(String fileId, String fileSeq);
     ...
     */
    void upload(Collection<MultipartFile> values, JFileVO fileVo);
     ...
     * @param fileId 파일 아이디
     */
    void executeAfterUploadCompleted(String fileId);
     ...
     * @return File 파일 객체
     */
    JFile getFile(String fileId, String fileSeq, String useSecurity);
     ...
     * @return JFile[] 파일 객체
     */
    JFile[] getFiles(String fileId, String useSecurity);
     ...
     * @return File 파일 객체
     */
    JFile getFileBySequence(String fileId, String fileSeq, String useSecurity);
