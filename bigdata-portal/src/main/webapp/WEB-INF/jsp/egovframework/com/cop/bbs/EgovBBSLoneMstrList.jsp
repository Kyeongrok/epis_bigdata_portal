	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    ...
	    <!-- 
	      ...
	      <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
	     -->
	    	<td><span class="button"><input type="submit" value="조회" title="조회" onclick="fn_egov_select_brdMstr('1');return false;"></span></td>
	    	<td><span class="button"><input type="button" value="등록" title="등록" onclick="fn_egov_insert_addBrdMstr();return false;"></span></td>
	    </tr>
	   </table>
	  </th>
	 </tr>
