...
public class UserManageVO extends UserDefaultVO{
	 ...
	 * @return
	 */
	public static UserManageVO parseUser(JSONObject userInfo) {
		UserManageVO user = new UserManageVO();
		
		user.setHomeadres(userInfo.get("userAdres").toString());
		user.setEmplyrNm(userInfo.get("userNm").toString());
		user.setEmplyrId(userInfo.get("userId").toString());
		user.setZip(userInfo.get("userZip").toString());
		user.setEmailAdres(userInfo.get("userEmail").toString());
		user.setPassword(userInfo.get("password").toString());
		user.setPasswordCnsr(userInfo.get("passwordCnsr").toString());
		user.setPasswordHint(userInfo.get("passwordHint").toString());
		user.setAreaNo(userInfo.get("areaNo").toString());
		user.setHomeendTelno(userInfo.get("endTelNo").toString());
		user.setHomemiddleTelno(userInfo.get("middleTelNo").toString());
		user.setMoblphonNo(userInfo.get("moblphonNo").toString());
		user.setEmplyrSttusCode(userInfo.get("sttus").toString());
	...
	public String toString() {
		return "UserManageVO [oldPassword=" + oldPassword + ", sbscrbDe=" + sbscrbDe + ", uniqId=" + uniqId
				...
				+ ", password=" + password + ", passwordCnsr=" + passwordCnsr + ", passwordHint=" + passwordHint
				+ ", sbscrbDeBegin=" + sbscrbDeBegin + ", sbscrbDeEnd=" + sbscrbDeEnd + ", sexdstnCode=" + sexdstnCode
				+ ", zip=" + zip + ", subDn=" + subDn + ", dirSize=" + dirSize + ", quotaSize=" + quotaSize + "]";
	}
