...
<script src="<c:url value='/js/bigdata/portal/svc/retnFmlg/jj_a.js'/>" defer></script>
<script src="<c:url value='/js/bigdata/portal/svc/retnFmlg/jj_b.js'/>" defer></script>
...
<!-- 중앙 컨텐츠 영역 -->
        <section class="cntWrap result" id="main_content">
	    	...
	    	<div class="menuTop" id="menu_top">
	    		<ul>
	    			<li class="on"><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_03.html#result02" class="scrollMove"><span>지역정보</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_03.html#result05" class="scrollMove"><span>지원정책</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_03.html#result03" class="scrollMove"><span>정주여건</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_03.html#result04" class="scrollMove"><span>품목정보</span></a></li>
	    			<li><a href="http://webdev.ucsit.co.kr/2020/BDP/farmIntent/viewResult_03.html#result01" class="scrollMove"><span>귀농인정보</span></a></li>
	    		</ul>
	    	</div>
	    	<!-- //상단고정 -->
	    	...
	    	<div class="resultBox" id="result02">
	        	...
	        	<div class="row mt20">
        			<div class="areaList w65p">
        				...
        				<button type="button" class="num02" onclick="location.href='./test1-2.do'">
        					<span class="num">2</span>
        					<span class="txt">경상북도 예천군 호명면</span>
        					<span class="btn">정보 보기</span>
        				</button>
        				<button type="button" class="num03 on" onclick="location.href='./test1-3.do'">
        			...
        			<div class="w32p fr">
        				<div class="diagram">
        					<img src="/images/bigdata/svc/retnFmlg/smpl_img01_3.png" alt="다이어그램" style="margin:30px 0 0 30px;display:inline-block;">
        				</div>
        			</div>
        		</div>
	        ...
	        <div class="resultBox support" id="result05">
	        	<h3>지역맞춤 귀농교육 및 지원정책 - 제주도 제주시</h3>
	        	...
	        	<a id="btn_popup_open" href="#">
		        	<img src="/images/bigdata/svc/retnFmlg/smpl_img02_3.png" alt="다이어그램" style="margin:10px 0 0 0;display:inline-block;">
		        </a>
	        </div><!-- //resultBox result05 -->


	        <div class="resultBox" id="result03">
	        	<h3>지역 정주 여건 정보 - 제주도 제주시</h3>
		    	<div class="tabWrap has8Tab">
                	...
                	<div class="tabContWrap">
                		<!-- <div class="tabcontent on">
                			<img src="/images/bigdata/svc/retnFmlg/smpl_graph19_3.png" alt="" style="margin:35px 0 0 25px;display:inline-block;">
                		</div>
                		...
                		<div class="tabcontent on">
                			<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_0_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_0_1" ></canvas></div>
                			</div>
                			<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_0_2" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_0_3" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="jj_a_1_0" ></canvas></div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="jj_a_1_1" ></canvas></div>
	                			<div class="graphWrap" style="width:33%;float:left;height:250px;"><canvas id="jj_a_1_2" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_2_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_2_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_3_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_3_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_4_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_4_1" ></canvas></div>
                			</div>
                			<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_4_2" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_4_3" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<div>
	                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_a_5_0" ></canvas></div>
	                			<div class="graphWrap" style="width:65%;float:left;height:250px;"><canvas id="jj_a_5_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
            				<img src="/images/bigdata/svc/retnFmlg/smpl_graph25.png" alt="" style="margin:35px 0 0 25px;display:inline-block;">
	        	...
	        	<div class="tabWrap">
		        	<ul class="tabTitle itemList">
                		...
                		<li class="tablinks on">
	        				<button type="button"><span>귤</span></button>
                		</li>
                		<li class="tablinks">
	        				<button type="button"><span>당근</span></button>
                		</li>
                		<li class="tablinks">
	        				<button type="button"><span>배추</span></button>
                		</li>
                	</ul>
                	<div class="tabContWrap">
                		<div class="tabcontent on">
            				<div class="tabWrap has5Tab">
			                	...
			                	<div class="tabContWrap">
			                		<!-- <div class="tabcontent on">
			            				<img src="/images/bigdata/svc/retnFmlg/smpl_img03_3.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;">
			                		</div>
			                		<div class="tabcontent">
			                		...
			                		<div class="tabcontent on">
			                			<img src="/images/bigdata/svc/retnFmlg/smpl_img03_3.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;">
			            				<%-- <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_g_0_0" ></canvas></div>
			                			</div> --%>
			                		</div>
			                		<div class="tabcontent">
				                		<div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_g_1_0" ></canvas></div>
			                			</div>
			                		</div>
			                		<div class="tabcontent">
			                			<img src="/images/bigdata/svc/retnFmlg/smpl_graph28.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
			                		  	<%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_g_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_g_2_0" ></canvas></div>
			                			</div> --%>
			                		</div>
			                		<div class="tabcontent">
				                		<div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_g_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_g_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_g_3_2" ></canvas></div>
			                			</div>
			                		</div>
			                		<div class="tabcontent">
				                		<img src="/images/bigdata/svc/retnFmlg/smpl_img07.png" alt="" style="margin:30px 0 10px 0;display:inline-block;">
            				...
            				<div class="tabWrap has5Tab">
                                ...
                                <div class="tabContWrap">
                                    ...
                                    <div class="tabcontent on">
                                    	<img src="/images/bigdata/svc/retnFmlg/smpl_bean01.png" alt="" style="margin:30px 0 10px 10px;display:inline-block;">
                                        <%-- <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_dg_0_0" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_dg_1_0" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                    	<img src="/images/bigdata/svc/retnFmlg/smpl_bean03.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
                                        <%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_dg_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_dg_2_1" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_dg_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_dg_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_dg_3_2" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                        <img src="/images/bigdata/svc/retnFmlg/smpl_bean05.png" alt="" style="margin:30px 0 10px 0;display:inline-block;">
            				...
            				<div class="tabWrap has5Tab">
                                ...
                                <div class="tabContWrap">
                                    ...
                                    <div class="tabcontent on">
                                        ...
                                        <%-- <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_bc_0_0" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <div>
				                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_b_bc_1_0" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                    	<img src="/images/bigdata/svc/retnFmlg/smpl_berry03.png" alt="" style="margin:30px 0 10px 50px;display:inline-block;">
                                        <%-- <div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_bc_2_0" ></canvas></div>
				                			<div class="graphWrap" style="width:48%;float:left;height:250px;"><canvas id="jj_b_bc_2_1" ></canvas></div>
			                			</div> --%>
                                    </div>
                                    <div class="tabcontent">
                                        <div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_bc_3_0" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_bc_3_1" ></canvas></div>
				                			<div class="graphWrap" style="width:32%;float:left;height:250px;"><canvas id="jj_b_bc_3_2" ></canvas></div>
			                			</div>
                                    </div>
                                    <div class="tabcontent">
                                        <img src="/images/bigdata/svc/retnFmlg/smpl_berry05.png" alt="" style="margin:30px 0 10px 0;display:inline-block;">
	        ...
	        <div class="resultBox" id="result01">
				...
				<div class="tabWrap has5Tab">
                	...
                	<div class="tabContWrap">
                		...
                		<%-- <div class="tabcontent on">
                			<div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_c_0_0" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
                			<div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_c_0_1" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
                			<div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_c_0_2" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
                			<div>
	                			<div class="graphWrap" style="width:100%;float:left;height:250px;"><canvas id="jj_c_0_3" ></canvas></div>
                			</div>
                		</div>
                		<div class="tabcontent">
                			<img src="/images/bigdata/svc/retnFmlg/smpl_img11.png" alt="" style="margin:20px 0 10px 10px;display:inline-block;">
...
$(function(){
	tempSrchObj.sido = '제주특별자치도';
	tempSrchObj.sigungu = '제주시';
	tempSrchObj.umd = '한림읍';
})
</script>