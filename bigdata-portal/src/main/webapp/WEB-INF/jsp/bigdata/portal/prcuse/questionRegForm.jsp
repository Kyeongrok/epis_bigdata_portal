...
<script type="text/javascript" src="<c:url value="/js/bigdata/portal/prcuse/questionRegForm.js" />"></script>

<div class="wrap_admin">

	<h3 class="mt0"><i class="ico ico_arrow_grey"></i>문의사항 등록</h3>

	<form name="rf" id="rf">
	<input type="hidden" name="bbsGbn" value="Q" />
	...
	<div class="tac mt20 disinblock w100p">
		<a href="<c:url value='/bdp/prcuse/noticeList.do'/>" class="btn floatl"><spring:message code="button.list" /></a>
