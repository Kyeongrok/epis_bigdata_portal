...
public class EgovLoginPolicyController {
    ...
    public String selectLoginPolicyList(@ModelAttribute("loginPolicyVO") LoginPolicyVO loginPolicyVO,
    	...
    	pageInfo.setCurrentPageNo(loginPolicyVO.getPageIndex());
    	pageInfo.setRecordCountPerPage(loginPolicyVO.getPageUnit());
    	pageInfo.setPageSize(loginPolicyVO.getPageSize());
    	int articleNo = pageInfo.getArticleNo();

        loginPolicyVO.setFirstIndex(pageInfo.getFirstRecordIndex());
        loginPolicyVO.setLastIndex(pageInfo.getLastRecordIndex());
        loginPolicyVO.setRecordCountPerPage(pageInfo.getRecordCountPerPage());
