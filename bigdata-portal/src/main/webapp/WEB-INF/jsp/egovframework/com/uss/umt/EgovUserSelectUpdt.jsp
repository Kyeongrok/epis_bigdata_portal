...
<body>
        ...
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr>
                ...
                <td width="80%" nowrap>
                    <input name="zip_view" id="zip_view" type="text" size="20" value="<c:out value='${userManageVO.zip}'/>"  maxlength="8" title="우편번호"/>
            ...
            <tr>
                ...
                <td width="80%" nowrap>
                    <form:input path="homeadres" id="homeadres" cssClass="txaIpUmt" size="40" maxlength="100" title="주소"/>
            ...
            <tr>
            	...
            	<td width="80%" nowrap>
					${viewQuotaSizeMB} MB
					<input id="quotaSize" name="quotaSize" class="txaIpUmt" type="text" value="${quotaSize}" size="20" maxlength="20">         
            	</td>
            </tr>
            <tr>
            	<th width="20%" height="23" class="required_text" nowrap >
