  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<c:when test="${preview == 'true'}">
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" onload="calcHeight();" src="<c:url value='/cop/cmy/previewCmmntyMainContents.do'/>" frameborder="0" width="758" height="480" title="컨텐츠영역"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:when>
        <c:otherwise>
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" onload="calcHeight();" src="<c:url value='/cop/cmy/CmmntyMainContents.do'/>?cmmntyId=<c:out value='${cmmntyVO.cmmntyId}' />" frameborder="0" width="758" height="480" title="컨텐츠영역"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:otherwise>
        </c:choose>
          <br />
