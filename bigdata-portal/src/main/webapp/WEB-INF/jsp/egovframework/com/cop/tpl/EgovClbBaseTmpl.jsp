        ...
        <td align="left"><table width="917" border="0" cellpadding="0" cellspacing="0" background="<c:url value='/images/egovframework/com/cop/tpl/top_menu_bg.gif' />">
          <tr>
            ...
            <td align="left"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="padding-right:10px; padding-left:10px;"><a href="#LINK" onclick="fn_egov_goCmmntyHome();return false;" class="comun">처음으로</a></td>
              ...
              <tr>
                <td align="left"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    ...
                    <td><a href="#LINK" onclick="fn_egov_loadBdList('<c:out value="${bbs.bbsId}"/>','<c:out value="${bbs.bbsAttrbCode}"/>','<c:out value="${bbs.bbsTyCode}"/>');">
                ...
                <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<a href="#LINK" onclick="fn_egov_registUser('<c:out value="${clubVO.clbId}" />','<c:out value='${clubVO.cmmntyId}' />')"><span class="f_step">가입신청</span></a>
						</c:otherwise>
					</c:choose>
                    </td>
                    <td width="6"><img src="<c:url value='/images/egovframework/com/cop/tpl/1_step_right.gif' />" width="6" height="23" alt="left menu" /></td>
